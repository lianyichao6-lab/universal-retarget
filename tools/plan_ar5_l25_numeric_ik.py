...
def main() -> None:
    ...
    if args.fps <= 0.0 or args.close_frames < 1 or args.close_hold_frames < 0 or args.lift_hold_frames < 0:
        parser.error("fps and close-frames must be positive; hold frames must be non-negative")
