...
ROBOT_CONFIGS = {
    ...
    # Local LinkerHand registry entries. These use the audited URDF assets;
    # generic mimic handling keeps coupled distal joints out of the solve.
    'linkerhand_l25': {
        'origin_link': 'hand_base_link',
        'tip_links': ['thumb_distal', 'index_distal', 'middle_distal', 'ring_distal', 'pinky_distal'],
        'tip_offsets': [[-0.008849, -0.000018, 0.030758], [-0.015799, -0.000013, 0.022931], [-0.015799, -0.000013, 0.022931], [-0.015799, -0.000013, 0.022931], [-0.015799, -0.000013, 0.022931]],
        'link1_names': ['thumb_metacarpals_base1', 'index_metacarpals', 'middle_metacarpals', 'ring_metacarpals', 'pinky_metacarpals'],
        ...
        'urdf_subdir': 'assets/linkerhand_l25',
        'urdf_file': {'right': 'right/linkerhand_l25_right.urdf', 'left': 'left/linkerhand_l25_left.urdf'},
        'num_fingers': 5,
        'neutral_qpos': [0.0] * 21,
    },
    'linkerhand_o6': {
        ...
        'tip_offsets': None,
        'link1_names': ['rh_thumb_metacarpals_base2', 'rh_index_proximal', 'rh_middle_proximal', 'rh_ring_proximal', 'rh_pinky_proximal'],
        'link3_names': ['rh_thumb_metacarpals', 'rh_index_distal', 'rh_middle_distal', 'rh_ring_distal', 'rh_pinky_distal'],
        'link4_names': ['rh_thumb_distal', 'rh_index_distal', 'rh_middle_distal', 'rh_ring_distal', 'rh_pinky_distal'],
        'urdf_subdir': 'assets/linkerhand_o6',
        'urdf_file': {'right': 'right/linkerhand_o6_right.urdf', 'left': 'left/linkerhand_o6_left.urdf'},
        'num_fingers': 5,
        'neutral_qpos': [0.0] * 11,
    },
    'linkerhand_l6': {
        'origin_link': 'rh_hand_base_link',
        'tip_links': ['rh_thumb_tip', 'rh_index_tip', 'rh_middle_tip', 'rh_ring_tip', 'rh_pinky_tip'],
        'tip_offsets': None,
        'link1_names': ['rh_thumb_metacarpals_base1', 'rh_index_proximal', 'rh_middle_proximal', 'rh_ring_proximal', 'rh_pinky_proximal'],
        'link3_names': ['rh_thumb_metacarpals', 'rh_index_distal', 'rh_middle_distal', 'rh_ring_distal', 'rh_pinky_distal'],
        'link4_names': ['rh_thumb_distal', 'rh_index_distal', 'rh_middle_distal', 'rh_ring_distal', 'rh_pinky_distal'],
        'urdf_subdir': 'assets/linkerhand_l6',
        'urdf_file': {'right': 'right/linkerhand_l6_right.urdf', 'left': 'left/linkerhand_l6_left.urdf'},
        'num_fingers': 5,
        'neutral_qpos': [0.0] * 11,
    },
    # ROHand
